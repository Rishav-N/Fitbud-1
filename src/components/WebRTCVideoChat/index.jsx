...
const VideoCall = (props) => {
  ...
  useEffect(async () => {
    ...
    webcamVideo = await navigator.mediaDevices.getUserMedia({
      video: true,
      audio: true,
    });
    remoteStream = new MediaStream();
    // Push tracks from local stream to peer connection
    webcamVideo.getTracks().forEach((track) => {
      pc.addTrack(track, webcamVideo);
    });
  ...
  return (
    <>
      <div className="userVideos">
          ...
          <div className="localFeed">
            <div className="nameTag">
              ...
              <div>
                ...
                <p className="username">Rishav Nair</p>
              </div>
            </div>
        ...
        <div>
          <div className="liveStatTitle"></div>
          <div className="liveStatContainer">
            <div className="workoutCounterContainer">
              ...
              <div className="workoutCounterAlignment">
                <p className="workoutType"> Workout Type: Cardio Fitness</p>
                ...
                return (
                  <>
                    <div className="workoutCounterAlignment">
                      ...
                      <p className="overallRepCount">{exerciseCount[key]}/100</p>
                    </div>
            ...
            <div className="calTime">
              <div className="activeTimeContainer">
                ...
                <p className="activeTimeValue">{Math.floor(time)}</p>
              </div>
